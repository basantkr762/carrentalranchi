...
<head>
    ...
    <style>
        ...
        .whatsapp-float{position:fixed;bottom:25px;right:25px;background:#25D366;color:#fff;width:60px;height:60px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:28px;box-shadow:0 5px 25px rgba(37,211,102,0.4);z-index:999;text-decoration:none;transition:transform 0.3s}
        .whatsapp-float:hover{transform:scale(1.1)}
        .call-float{position:fixed;bottom:25px;left:25px;background:linear-gradient(135deg,#667eea,#764ba2);color:#fff;width:60px;height:60px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:22px;box-shadow:0 5px 25px rgba(102,126,234,0.4);z-index:999;text-decoration:none;transition:transform 0.3s;animation:pulse 2s infinite}
        .call-float:hover{transform:scale(1.1)}
        @keyframes pulse{0%{box-shadow:0 0 0 0 rgba(102,126,234,0.5)}70%{box-shadow:0 0 0 15px rgba(102,126,234,0)}100%{box-shadow:0 0 0 0 rgba(102,126,234,0)}}
